    ...
    <Layout home>
      ...
      <section className="max-w-none">
        <h1 className="text-2xl sm:text-4xl">
          I&rsquo;m Jamie Perkins. Software engineer, bootstrapper and dedicated dad.
        </h1>
      </section>
          ...
          <div className="divide-y divide-neutral divide-dotted mb-12">
            ...
            <div id="mc_embed_signup">
              <p className="sm:text-xl font-light">
                <strong>What&rsquo;s next?</strong> Get updates about what I&rsquo;m working on:
              </p>
              <form
                className="flex"
                action="https://inorganik.us6.list-manage.com/subscribe/post?u=652faf8fd19848d965f2d07dd&amp;id=d5900362dc"
                method="post"
              ...
              >
                <input
                  ...
                  name="EMAIL"
                  placeholder="Email"
                  className="input input-sm input-bordered rounded-lg flex-grow max-w-xs"
                  id="mce-EMAIL"
                />
                <input
                  type="submit"
                  defaultValue="submit"
                  name="subscribe"
                  className="btn btn-sm btn-primary rounded-lg ml-3"
                ...
                <div className="absolute left-[-5000px]" aria-hidden="true">
                  <input
                    type="text"
                    name="b_652faf8fd19848d965f2d07dd_d5900362dc"
                    tabIndex="-1"
                    defaultValue=""
                  />
                </div>
