  ...
  return (
    <div className="mb-6 mx-auto px-4 max-w-6xl relative flex flex-col min-h-full">
      <Head>
        ...
        <meta
          name="description"
          content="JeffCo ACFR data from 2006-2025"
        />
      ...
      <section className="prose mt-12 max-w-none">
        <article className="max-w-none flex flex-col">
          ...
          <p>JeffCo public schools is facing a <a href="https://cotlns-newsletter-education.beehiiv.com/p/what-jeffco-s-deepening-deficit-means-for-november" target="_blank">$68 million budget shortfall</a> and as a father of 2 JeffCo students, I wanted to understand the budget better. So I compiled 20 years of data from JeffCo's Annual Comprehensive Financial Reports. Here are the headlines:</p>
          <ul>

            </ul>
          <p><a href="https://docs.google.com/spreadsheets/d/1UKSAyTid9bnt_9dLHvFNYv0C9XsniD2D4yG7-DGq-ME/edit?usp=sharing" target="_blank">You can find the google sheet driving this data here.</a></p>
