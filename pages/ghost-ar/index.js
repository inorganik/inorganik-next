    ...
    <div className="mb-6 mx-auto px-4 w-full sm:max-w-7xl">
      ...
      <main className="app">
        <section className="lg:h-[90vh] items-center grid lg:grid-cols-2 lg:min-h-[800px]">
          <div>
            <Image
              src="/images/ghost-ar/ghost-ar-on-black.png"
              width={522}
              height={522}
              priority
            ...
            <div className="my-4 sm:my-8 py-7 flex justify-center">
              <a
                className="mx-4"
                href="https://apps.apple.com/us/app/ghost-ar-live-action-ghosts/id1591628036"
              >
                <img
            ...
            <div className="text-center">
              <p className="my-4">
                An augmented reality app brought to you by{' '}
          ...
          <div className="max-h-screen">
            <div
              className="w-full h-[600px] sm:w-[400px] sm:h-auto mx-auto relative"
              ref={carousel}
            >
              <div>
                <Image
                  src="/images/ghost-ar/app-store-1-5.5.jpg"
                  width={621}
                  height={1104}
                  priority
                  alt="Encounter 4 unique live-action ghosts"
                />
              </div>
              <div>
                <Image
                  src="/images/ghost-ar/app-store-2-5.5.jpg"
                  width={621}
                  height={1104}
                  priority
                  alt="Capture realistic ghost photos"
                />
              </div>
            </div>
          </div>
